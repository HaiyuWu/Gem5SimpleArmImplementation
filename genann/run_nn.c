...
const char *iris_data = "/home/nle5/Final_project/genann/example/iris.data";
...
void load_data() {
    ...
    FILE *in = fopen("/home/nle5/Final_project/genann/example/iris.data", "r");
    if (!in) {
...
int main(int argc, char *argv[])
{
    ...
    //const char *save_name = "/home/nle5/Final_project/genann/example/iris.ann";
     ...
     */
    genann *ann = genann_init(4, 1, 2, 3);
    ...
    const char *save_name = "/home/nle5/Final_project/genann/example/iris_prune_nodes.ann";
    FILE *saved = fopen(save_name, "r");
